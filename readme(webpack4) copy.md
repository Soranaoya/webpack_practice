...
```
production optionだとファイルをできるだけ小さくしてくれる
development


実際の開発において、distディレクトリを確認することはない
(ビルド設定を確認するくらい)
...
vscodeでは.gitignoreに対象になったファイルは灰色に変わる
また、git status で表示した際に含まれなくなる
